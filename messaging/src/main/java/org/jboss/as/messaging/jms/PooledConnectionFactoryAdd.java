...
public class PooledConnectionFactoryAdd extends AbstractAddStepHandler implements DescriptionProvider {
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model, ServiceVerificationHandler verificationHandler,
        ...
        if (discoveryGroupName != null) {
            ...
            jgroupsStack = JGROUPS_STACK.resolveModelAttribute(context, dgModel).asString();
        ...
        PooledConnectionFactoryService resourceAdapterService = new PooledConnectionFactoryService(name, connectors, discoveryGroupName, jgroupsStack, jgroupsChannelName, adapterParams, jndiNames, txSupport, minPoolSize, maxPoolSize);
