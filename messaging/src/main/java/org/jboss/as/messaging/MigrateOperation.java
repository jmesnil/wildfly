...
public class MigrateOperation implements OperationStepHandler {
    ...
    private static AttributeDefinition DRY_RUN = SimpleAttributeDefinitionBuilder.create("dry-run", BOOLEAN)
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        final boolean dryRun = DRY_RUN.resolveModelAttribute(context, operation).asBoolean();
        ...
        addMessagingActiveMQExtension(context, migrationOperations, dryRun);
        context.addStep(new OperationStepHandler() {
            ...
            public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
                ...
                if (dryRun) {
                    // for dry run, do nothing and return the list of operations that would
