...
public enum Element {
   ...
   CLUSTER_NOTIFICATION_ATTEMPTS(CommonAttributes.CLUSTER_NOTIFICATION_ATTEMPTS),
   CLUSTER_NOTIFICATION_INTERVAL(CommonAttributes.CLUSTER_NOTIFICATION_INTERVAL),
