...
class HttpConnectorService implements Service<Void> {
    ...
    static ServiceController<Void> addService(ServiceTarget serviceTarget,
        ...
        final ServiceName serviceName = HttpConnectorService.getServiceName(hornetqServerName, connectorName);
        final HttpConnectorService service = new HttpConnectorService(hornetqServerName, connectorName);
    ...
    HttpConnectorService(final String hornetqServerName, final String connectorName) {
