...
public class PooledConnectionFactoryService implements Service<Void> {
...

   {
    ...
    public PooledConnectionFactoryService(String name, List<String> connectors, String discoveryGroupName, String jgroupsStack, String jgroupsChannelName, List<PooledConnectionFactoryConfigProperties> adapterParams, List<String> jndiNames, String txSupport, int minPoolSize, int maxPoolSize) {
        this.name = name;
        ...
        try {
            ...
            if(discoveryGroupName != null) {
                ...
                if (bgCfg instanceof UDPBroadcastGroupConfiguration) {
                    ...
                    properties.add(simpleProperty15(JGROUPS_CHANNEL_REF_NAME, STRING_TYPE, jgroupsChannelName));
