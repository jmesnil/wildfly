...
/**
 * The remove operation for the messaging subsystem's http-connector resource.
 *
...
public class HTTPConnectorRemove extends AbstractRemoveStepHandler {
    ...
    protected void recoverServices(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        HTTPConnectorAdd.INSTANCE.launchServices(context, hornetqServerName, connectorName, model, null, null);
    }
}
