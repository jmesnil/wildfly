 ...
 *
 */
public class JGroupsBroadcastGroupConfigurationWithChannel implements BroadcastEndpointFactoryConfiguration
{
    private static final long serialVersionUID = -3719008253895137980L;

    private final String jgroupsRef;

    private final String jgroupsChannel;

    private transient JChannel channelInstance;

    public JGroupsBroadcastGroupConfigurationWithChannel(String jgroupsRef, String jgroupsChannel) {
    ...
    public BroadcastEndpointFactory createBroadcastEndpointFactory() {
        return new JGroupsChannelEndpointFactory(channelInstance, jgroupsChannel);
    }
    ...
    public void setChannelInstance(JChannel createChannel) {
        this.channelInstance = createChannel;
    }
