...
/**
 * Process {@link JMSConnectionFactoryDefinitions}(s) and {@link JMSDestinationDefinition}(s) annotations.
 *
...
public class MessagingJMSDefinitionAnnotationParser implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        for (AnnotationInstance annotation : index.getAnnotations(JMS_CONNECTION_FACTORY_DEFINITIONS)) {
            ...
            // get the nested @JMSConnectionFactoryDefinition out of the outer @JMSConnectionFactoryDefinitions
            List<AnnotationInstance> connectionFactoryDefinition = getNestedDefinitionAnnotations(annotation);
            for (AnnotationInstance definition : connectionFactoryDefinition) {
    ...
    /**
     * Returns the nested {@link JMSConnectionFactoryDefinition} (resp. {@link JMSDestinationDefinition} annotations out
     * of the outer {@link JMSConnectionFactoryDefinitions} (resp. {@link JMSDestinationDefinitions} annotation
     *
     * @param definitions The outer {@link JMSConnectionFactoryDefinitions} or {@link JMSDestinationDefinitions} annotation
     */
