...
public class DirectJMSDestinationInjectionSource extends InjectionSource {
    ...
    private <D extends Destination> void bindDestination(ResolutionContext context, ServiceTarget serviceTarget, ServiceBuilder<?> serviceBuilder, Injector<ManagedReferenceFactory> injector, Service<D> service) {
        final ContextListAndJndiViewManagedReferenceFactory referenceFactoryService = new MessagingJMSDestinationManagedReferenceFactory(service);
