...
package org.wildfly.test.integration.microprofile.config.app;

import static org.wildfly.test.integration.microprofile.config.AssertUtils.assertTextContainsProperty;
import static org.wildfly.test.integration.microprofile.config.HttpUtils.getContent;
import static org.wildfly.test.integration.microprofile.config.SubsystemConfigSourceTask.MY_PROP_FROM_SUBSYSTEM_PROP_NAME;
import static org.wildfly.test.integration.microprofile.config.SubsystemConfigSourceTask.MY_PROP_FROM_SUBSYSTEM_PROP_VALUE;
...
import org.wildfly.test.integration.microprofile.config.SubsystemConfigSourceTask;
...
public class MicroProfileConfigTestCase {
    ...
    public void testGetWithConfigProperties() throws Exception {
        try (CloseableHttpClient client = HttpClientBuilder.create().build()) {
            ...
            // FIXME uncomment once wildfly-microprofile-config is released with https://github.com/wildfly-extras/wildfly-microprofile-config/issues/43
