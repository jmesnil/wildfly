...
/**
 * A MDB deployed with deliveryActive to false using (deprecated) activation config property.
 *
 * @author <a href="http://jmesnil.net/">Jeff Mesnil</a> (c) 2013 Red Hat inc.
 */
@MessageDriven(activationConfig = {
        @ActivationConfigProperty(propertyName = "destination", propertyValue = "java:jboss/deliveryactive/MDBWithActivationConfigQueue"),
...
public class MDBWithDeliveryActiveActivationConfigProperty implements MessageListener {
