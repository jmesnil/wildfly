...
public class MigrateTestCase extends AbstractSubsystemTest {
    ...
    private void testMigrateOperation(boolean addLegacyEntries) throws Exception {
        ...
        // 1 warnings about broadcast-group attributes not migrated because they have an expression.
        // 5 warnings about discovery-group attributes that can not be migrated.
        // 1 warnings about discovery-group attributes not migrated because they have an expression.
        ...
        int expectedNumberOfWarnings = 6 + 1 + 5 + 1 + 3 + 1 + 1 + 1;
