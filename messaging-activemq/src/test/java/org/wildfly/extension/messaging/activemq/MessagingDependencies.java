...
public class MessagingDependencies {
    ...
    static final String MESSAGING_ACTIVEMQ_MAVEN_GA = "org.wildfly:wildfly-messaging-activemq";
    ...
    static {
        ...
        // use WILDLFY_10_0_0_FINAL when ready
    ...
    static String[] getArtemisDependencies(ModelTestControllerVersion controllerVersion) {
