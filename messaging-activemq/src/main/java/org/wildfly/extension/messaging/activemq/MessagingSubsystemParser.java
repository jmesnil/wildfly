...
import static org.wildfly.extension.messaging.activemq.CommonAttributes.REMOTING_INCOMING_INTERCEPTORS;
import static org.wildfly.extension.messaging.activemq.CommonAttributes.REMOTING_OUTGOING_INTERCEPTORS;
   ...
   void processAcceptors(final XMLExtendedStreamReader reader, final ModelNode address, final List<ModelNode> updates) throws XMLStreamException {
    ...
    private ModelNode processSecuritySettings(final XMLExtendedStreamReader reader, final ModelNode address, final List<ModelNode> operations) throws XMLStreamException {
        ...
        do {
            ...
            final org.wildfly.extension.messaging.activemq.Element element = org.wildfly.extension.messaging.activemq.Element.forName(reader.getLocalName());
