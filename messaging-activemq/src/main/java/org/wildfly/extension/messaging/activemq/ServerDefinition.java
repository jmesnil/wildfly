...
public class ServerDefinition extends PersistentResourceDefinition {
    ...
    public static final AttributeDefinition[] ATTRIBUTES = {PERSISTENCE_ENABLED, DEFAULT_THREAD_POOL, DEFAULT_SCHEDULED_THREAD_POOL, SCHEDULED_THREAD_POOL_MAX_SIZE,
