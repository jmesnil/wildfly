...
class ServerAdd extends AbstractAddStepHandler {
    ...
    protected void populateModel(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
        ...
        context.addStep((operationContext, model) -> {
            ...
            // check that if the thread-pool attribute is defined, its matches a bounded-queue-thread-pool resource
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
        ...
        context.addStep(new OperationStepHandler() {
            ...
            public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
                ...
                ModelNode threadPoolName = ServerDefinition.THREAD_POOL.resolveModelAttribute(context, model);
                ...
                ModelNode scheduledTreadPoolName = ServerDefinition.SCHEDULED_THREAD_POOL.resolveModelAttribute(context, model);
