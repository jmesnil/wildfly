...
public interface ConnectorMessages {
     ...
     * @return a {@link DeploymentUnitProcessingException} for the error.
     */
    @Message(id = 10480, value = "Empty MDR while deploying %s")
     ...
     * @return a {@link DeploymentUnitProcessingException} for the error.
     */
    @Message(id = 10481, value = "Resource adapter (%s) not found while deploying %s")
     ...
     * @return a {@link DeploymentUnitProcessingException} for the error.
     */
    @Message(id = 10482, value = "Connection factory interface (%s) is incorrect for resource adapter '%s' while deploying %s")
     ...
     * @return a {@link DeploymentUnitProcessingException} for the error.
     */
    @Message(id = 10483, value = "Admin object declared for JCA 1.0 resource adapter '%s' while deploying %s")
     ...
     * @return a {@link DeploymentUnitProcessingException} for the error.
     */
    @Message(id = 10484, value = "Admin object class (%s) is incorrect for resource adapter '%s' while deploying %s")
