...
public class AdministeredObjectDefinitionAnnotationParser implements DeploymentUnitProcessor {
    ...
    private BindingConfiguration getBindingConfiguration(final AnnotationInstance adminObjectAnnotation) {
        ...
        final AnnotationValue nameValue = adminObjectAnnotation.value("name");
        ...
        final AnnotationValue classValue = adminObjectAnnotation.value("className");
        ...
        final AnnotationValue resourceAdapterValue = adminObjectAnnotation.value("resourceAdapter");
        ...
        final DirectAdministeredObjectInjectionSource directAdministeredObjectInjectionSource =
            new DirectAdministeredObjectInjectionSource(name, classValue.asString(), resourceAdapterValue.asString(), mdr);
