...
public class DirectConnectionFactoryInjectionSource extends InjectionSource {
    ...
    public void getResourceValue(final ResolutionContext context, final ServiceBuilder<?> serviceBuilder, final DeploymentPhaseContext phaseContext, final Injector<ManagedReferenceFactory> injector) throws DeploymentUnitProcessingException {
        ...
        try {
            ...
            for (String rar : rars) {
                if (rar.indexOf(resourceAdapter) != -1) {
                    raId = rar;
                }
            }
            ...
            Connector cmd = mdr.getResourceAdapter(raId);
            ...
            IronJacamar ijmd = new IronJacamarImpl(transactionSupportValue, raConfigProperties, Collections.<CommonAdminObject>emptyList(),
            ...
            activator.setBindInfo(ContextNames.bindInfoForEnvEntry(context.getApplicationName(), context.getModuleName(), context.getComponentName(), !context.isCompUsesModule(), jndiName));
            ...
            serviceBuilder.addDependency(activator.getBindInfo(jndiName).getBinderServiceName(), ManagedReferenceFactory.class, injector);

            SUBSYSTEM_RA_LOGGER.connectionFactoryAnnotation(jndiName);
