...
public class ModuleTaskTestCase extends AbstractTaskTestCase{
    ...
    public void testAddModule() throws Exception {
        ...
        ContentModification moduleAdded = new ContentModification(new ModuleItem(moduleName, ModuleItem.MAIN_SLOT, null, newHash), NO_CONTENT, ADD);
    ...
    public void testRemoveModule() throws Exception {
        ...
        ContentModification moduleRemoved = new ContentModification(new ModuleItem(moduleName, ModuleItem.MAIN_SLOT, null, NO_CONTENT), existingHash, REMOVE);
    ...
    public void testUpdateModule() throws Exception {
        ...
        ContentModification moduleUpdated = new ContentModification(new ModuleItem(moduleName, ModuleItem.MAIN_SLOT, null, updatedHash), existingHash, MODIFY);
