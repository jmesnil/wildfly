...
public class CumulativePatchTestCase extends AbstractTaskTestCase {
    ...
    public void testApplyCumulativePatch() throws Exception {
        ...
        ContentModification moduleAdded = new ContentModification(new ModuleItem(moduleName, null, null, newHash), NO_CONTENT , ADD);
    ...
    public void testApplyCumulativePatchAndRollback() throws Exception {
        ...
        ContentModification moduleAdded = new ContentModification(new ModuleItem(moduleName, null, null, newModuleHash), NO_CONTENT, ADD);
    ...
    public void testApplyCumulativePatchThenOneOffPatch() throws Exception {
        ...
        ContentModification moduleUpdated = new ContentModification(new ModuleItem(moduleName, null, null, updatedHash), newHash, MODIFY);
    ...
    public void testApplyCumulativePatchThenOneOffPatchThenRollbackCumulativePatch() throws Exception {
        ...
        ContentModification moduleAdded = new ContentModification(new ModuleItem(moduleName, null, null, updatedHashCP), existingHash, MODIFY);
        ...
        ContentModification moduleUpdated = new ContentModification(new ModuleItem(moduleName, null, null, updatedHashOneOff), updatedHashCP, MODIFY);
