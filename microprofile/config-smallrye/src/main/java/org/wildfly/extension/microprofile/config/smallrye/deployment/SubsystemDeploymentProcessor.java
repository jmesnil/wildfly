...
public class SubsystemDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) {
        ...
        SmallRyeConfigProviderResolver.INSTANCE.registerConfig(config, module.getClassLoader());
    ...
    public void undeploy(DeploymentUnit context) {
        ...
        SmallRyeConfigProviderResolver.INSTANCE.releaseConfig(ConfigProvider.getConfig(module.getClassLoader()));
    }
}
