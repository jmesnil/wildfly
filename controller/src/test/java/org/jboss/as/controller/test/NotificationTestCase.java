 ...
 */
public class NotificationTestCase extends AbstractGlobalOperationsTestCase {

    @Test
    public void testFoo() throws Exception {
        ModelNode node = new ModelNode();
        node.add("subsystem", "messaging");
        node.add("hornetq-server", "default");

        System.out.println("node = " + node);
        System.out.println("node = " + node.getType());

        PathAddress address = PathAddress.pathAddress(node);
