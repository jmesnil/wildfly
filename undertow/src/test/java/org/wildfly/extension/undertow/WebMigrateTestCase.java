...
public class WebMigrateTestCase extends AbstractSubsystemTest {
    ...
    public static final String WEB_SUBSYSTEM_NAME = "web";
    public static final String UNDERTOW_SUBSYSTEM_NAME = "undertow";

    public WebMigrateTestCase() {
        super(WEB_SUBSYSTEM_NAME, new WebExtension());
    }

    @Test
    public void testMigrateOperation() throws Exception {
        String subsystemXml = readResource("web-subsystem-migrate-2.2.0.xml");
        ...
        assertTrue(model.get(SUBSYSTEM, WEB_SUBSYSTEM_NAME).isDefined());
        ...
        migrateOp.get(OP_ADDR).add(SUBSYSTEM, WEB_SUBSYSTEM_NAME);
        ...
        assertFalse(model.get(SUBSYSTEM, WEB_SUBSYSTEM_NAME).isDefined());
