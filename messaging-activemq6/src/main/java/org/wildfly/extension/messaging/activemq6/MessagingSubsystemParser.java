...
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.FILTER;
...
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.REMOTING_INCOMING_INTERCEPTORS;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.REMOTING_OUTGOING_INTERCEPTORS;
...
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SELECTOR;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SUBSYSTEM;
   ...
   void processAcceptors(final XMLExtendedStreamReader reader, final ModelNode address, final List<ModelNode> updates) throws XMLStreamException {
    ...
    private ModelNode processSecuritySettings(final XMLExtendedStreamReader reader, final ModelNode address, final List<ModelNode> operations) throws XMLStreamException {
        ...
        do {
            ...
            final org.wildfly.extension.messaging.activemq6.Element element = org.wildfly.extension.messaging.activemq6.Element.forName(reader.getLocalName());
