...
import static org.wildfly.extension.messaging.activemq6.BinderServiceUtil.installAliasBinderService;
import static org.wildfly.extension.messaging.activemq6.MessagingServices.getHornetQServiceName;
...
import org.wildfly.extension.messaging.activemq6.HornetQActivationService;
import org.wildfly.extension.messaging.activemq6.JGroupsChannelLocator;
...
public class PooledConnectionFactoryService implements Service<Void> {
    ...
    private static final String HQ_ACTIVATION = "org.apache.activemq.ra.inflow.ActiveMQActivationSpec";
    private static final String HQ_CONN_DEF = "ActiveMQConnectionDefinition";
    private static final String HQ_ADAPTER = "org.apache.activemq.ra.ActiveMQResourceAdapter";
    private static final String RAMANAGED_CONN_FACTORY = "org.apache.activemq.ra.ActiveMQRAManagedConnectionFactory";
    private static final String RA_CONN_FACTORY = "org.apache.activemq.ra.ActiveMQRAConnectionFactory";
    private static final String RA_CONN_FACTORY_IMPL = "org.apache.activemq.ra.ActiveMQRAConnectionFactoryImpl";
    private static final String JMS_SESSION = "javax.jms.Session";
    private static final String HQ_SESSION = "org.apache.activemq.ra.ActiveMQRASession";
