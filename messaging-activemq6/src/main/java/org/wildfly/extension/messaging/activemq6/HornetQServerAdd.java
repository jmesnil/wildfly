...
package org.wildfly.extension.messaging.activemq6;

import static org.jboss.as.controller.descriptions.ModelDescriptionConstants.OP_ADDR;
import static org.jboss.as.controller.descriptions.ModelDescriptionConstants.PATH;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.ADDRESS_SETTING;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.ASYNC_CONNECTION_EXECUTION_ENABLED;
// FIXME
//import static org.wildfly.extension.messaging.activemq6.CommonAttributes.BACKUP;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.BACKUP_GROUP_NAME;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.BINDINGS_DIRECTORY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.BROADCAST_GROUP;
// FIXME
//import static org.wildfly.extension.messaging.activemq6.CommonAttributes.CHECK_FOR_LIVE_SERVER;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.CLUSTER_PASSWORD;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.CLUSTER_USER;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.CONNECTION_TTL_OVERRIDE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.CREATE_BINDINGS_DIR;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.CREATE_JOURNAL_DIR;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.DISCOVERY_GROUP;
// FIXME
//import static org.wildfly.extension.messaging.activemq6.CommonAttributes.FAILBACK_DELAY;
// FIXME
//import static org.wildfly.extension.messaging.activemq6.CommonAttributes.FAILOVER_ON_SHUTDOWN;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.HTTP_ACCEPTOR;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.ID_CACHE_SIZE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JGROUPS_CHANNEL;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JGROUPS_STACK;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JMX_DOMAIN;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JMX_MANAGEMENT_ENABLED;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_BUFFER_SIZE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_BUFFER_TIMEOUT;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_COMPACT_MIN_FILES;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_COMPACT_PERCENTAGE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_DIRECTORY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_FILE_SIZE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_MAX_IO;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_MIN_FILES;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_SYNC_NON_TRANSACTIONAL;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_SYNC_TRANSACTIONAL;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.JOURNAL_TYPE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.LARGE_MESSAGES_DIRECTORY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.LOG_JOURNAL_WRITE_RATE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MANAGEMENT_ADDRESS;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MANAGEMENT_NOTIFICATION_ADDRESS;
// FIXME
//import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MAX_SAVED_REPLICATED_JOURNAL_SIZE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MEMORY_MEASURE_INTERVAL;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MEMORY_WARNING_THRESHOLD;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MESSAGE_COUNTER_ENABLED;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MESSAGE_COUNTER_MAX_DAY_HISTORY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MESSAGE_COUNTER_SAMPLE_PERIOD;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MESSAGE_EXPIRY_SCAN_PERIOD;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.MESSAGE_EXPIRY_THREAD_PRIORITY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.OVERRIDE_IN_VM_SECURITY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.PAGE_MAX_CONCURRENT_IO;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.PAGING_DIRECTORY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.PERF_BLAST_PAGES;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.PERSISTENCE_ENABLED;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.PERSIST_DELIVERY_COUNT_BEFORE_DELIVERY;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.PERSIST_ID_CACHE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.REPLICATION_CLUSTERNAME;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.RUN_SYNC_SPEED_TEST;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SCHEDULED_THREAD_POOL_MAX_SIZE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SECURITY_DOMAIN;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SECURITY_ENABLED;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SECURITY_INVALIDATION_INTERVAL;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SECURITY_SETTING;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SERVER_DUMP_INTERVAL;
// FIXME
//import static org.wildfly.extension.messaging.activemq6.CommonAttributes.SHARED_STORE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.STATISTICS_ENABLED;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.THREAD_POOL_MAX_SIZE;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.TRANSACTION_TIMEOUT;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.TRANSACTION_TIMEOUT_SCAN_PERIOD;
import static org.wildfly.extension.messaging.activemq6.CommonAttributes.WILD_CARD_ROUTING_ENABLED;
import static org.wildfly.extension.messaging.activemq6.PathDefinition.PATHS;
import static org.wildfly.extension.messaging.activemq6.PathDefinition.RELATIVE_TO;
...
import org.wildfly.extension.messaging.activemq6.jms.JMSService;
import org.wildfly.extension.messaging.activemq6.logging.MessagingLogger;
